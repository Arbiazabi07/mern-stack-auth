        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-spark-darker via-spark-dark to-spark-darker">
            ...
            <div className="relative z-10 w-full max-w-md px-4">
                ...
                <div className="text-center mb-8 animate-fade-in">
                    ...
                    <p className="text-white/60 mt-2">Welcome back! Please login to your account</p>
                </div>
                ...
                <div className="spark-card p-8 animate-slide-up">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <Link to="/register" className="text-sm text-spark-primary hover:text-spark-secondary transition">
                            Create account
                        </Link>
                    </div>
                    ...
                    {/* Error Alert */}
                    {error && (
                        <div className="spark-alert-error mb-4">
                            {error}
                        </div>
                    )}
                        ...
                        <div className="flex items-center justify-between">
                            <label className="flex items-center">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 bg-white/10 border-white/20 rounded focus:ring-spark-primary"
                                />
                                <span className="ml-2 text-sm text-white/60">Remember me</span>
                            </label>
                            <Link to="/forgot-password" className="text-sm text-spark-primary hover:text-spark-secondary transition">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-spark-card text-white/40">Or continue with</span>
                        </div>
                    </div>

                    {/* Social Login */}
                    <div className="space-y-3">
                        <button className="w-full py-2 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 transition flex items-center justify-center gap-2">
